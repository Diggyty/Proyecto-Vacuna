...
namespace Proyecto_Vacuna
{
    public partial class FrmAgregarLote : Form
    {
        ...
        {
            // obtener
            string fechaEntrada, DiaAuto, DiaVenc, msg;
            int vacuna, silais, unidades;
            fechaEntrada = FechaEntrada.Value.ToString("yyyy/MM/dd");
            DiaAuto = FechAutorizacion.Value.ToString("yyyy/MM/dd");
            ...
            msg = Lote.guardarLote(vacuna, silais, fechaEntrada, unidades, DiaAuto, DiaVenc);
        ...
        {
            Form formulario = new FrmConsultaHistorial();
            formulario.Show();
        }
        ...
        public void limitar()
        {
            FechaEntrada.MaxDate = DateTime.Today.AddYears(+3);
            FechaEntrada.MinDate = DateTime.Today.AddDays(-1);
        }
        ...
        private void FechaEntrada_KeyPress(object sender, KeyPressEventArgs e)
        {

        }
        public void limitarv()
        {
            FechaEntrada.MaxDate = DateTime.Today.AddYears(+3);
            FechaEntrada.MinDate = DateTime.Today.AddDays(-1);
        }
