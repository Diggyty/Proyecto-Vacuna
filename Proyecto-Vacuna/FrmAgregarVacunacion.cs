...
namespace Proyecto_Vacuna
{
    ...
    public partial class FrmAgregarVacunacion : Form
    {
        ...
        public FrmAgregarVacunacion()
        {
            ...
            FechaVacunacion.MinDate = DateTime.Now;
            FechaSegDosis.Value = DateTime.Now;
            FechaSegDosis.MinDate = DateTime.Now;
        }

        public void FiltrarPaciente()
        {
            clsDatosConexion conexion = new clsDatosConexion();
            String query = "SELECT * FROM vistapersonasregistradas where cedula = '" + txtidpaciente.Text + "' or  nombre_personas = '" + txtnombrepaciente.Text + "' or apellido_personas = '" + txtapellidospaciente + "' ";
       ...
       /* void cmbLote()
        ...
        private void guna2DataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            clsLogicaVacunacion Load = new clsLogicaVacunacion();
            String cedula = this.mostrarpaciente.CurrentRow.Cells[1].Value.ToString();

            
           /* DataTable dt = Load.edadPersona(cedula);
            int edad = DateTime.Now.Year - dt.Rows[0].Field<DateTime>(0).Year;
            edad = dt.Rows[0].Field<DateTime>(0).Month < DateTime.Now.Month ? edad - 1 : edad;
           
            TxtEdadVacunacion.Text = (edad).ToString();*/
        ...
        private void TxtEstrategia_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtapellidospaciente_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validaciones.SoloLetras(e);
        }
        ...
        void delecte()
        {
            ...
            TxtEdadVacunacion.Text = "";
            txtvacuna.Text = "";
            CbxDosisAplicada.Text = "";
            FechaSegDosis.Text = "";
            TxtEstrategia.Text = "";
            txtlote.Text = "";
            txtjornada.Text = "";
        ...
        private void TxtEdadVacunacion_KeyPress(object sender, KeyPressEventArgs e)
        {
            Validaciones.SoloNumeros(e);
        }
    }
